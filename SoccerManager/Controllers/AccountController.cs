...
namespace SoccerManager.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //zoek het team van de gebruiker
            var userTeam = db.Teams.Where(t => t.CoachId == WebSecurity.CurrentUserId).ToList();
            ...
            {                
                userTeam = db.Teams.Where(t => t.CoachId == null).ToList();
                //boolean meegeven zodat ik in de view kan checken of de coach een team heeft
        ...
        {
            //team pakken aan de hand van meegekregen id
            var team = db.Teams.Find(id);

            db.Entry(team).State = System.Data.EntityState.Modified;
            //currentUserId opslaan bij de CoachId 
            team.CoachId = WebSecurity.CurrentUserId;
            db.SaveChanges();
